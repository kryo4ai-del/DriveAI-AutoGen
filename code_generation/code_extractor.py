...
_BLOCKED_NAMES: frozenset[str] = frozenset({
    ...
    # Swift/Foundation/SwiftUI framework types — NEVER extract as standalone files
    "Hashable", "Codable", "Equatable", "Comparable", "Identifiable",
    "Decodable", "Encodable", "CustomStringConvertible", "CaseIterable",
    "RawRepresentable", "ObservableObject", "View", "App", "Scene",
    "PreviewProvider", "Task", "LocalizedError",
    "Publisher", "Subscriber", "Cancellable", "AnyCancellable",
    "AsyncSequence", "AsyncIteratorProtocol", "Actor",
    "Sendable", "MainActor", "GlobalActor",
    "EnvironmentKey", "PreferenceKey", "ViewModifier",
    "ObservedObject", "StateObject", "EnvironmentObject",
    "Binding", "State", "Published", "Environment",
    "NavigationView", "NavigationLink", "TabView",
    "LazyVGrid", "LazyHGrid", "LazyVStack", "LazyHStack",
    ...
    "NotificationCenter", "UserDefaults", "FileManager", "Bundle",
    "Timer", "Calendar", "DateFormatter", "DateComponents",
    "UUID", "Locale", "TimeZone",
    "DispatchQueue", "OperationQueue",
    "NSObject", "NSCoder", "NSError",
})
