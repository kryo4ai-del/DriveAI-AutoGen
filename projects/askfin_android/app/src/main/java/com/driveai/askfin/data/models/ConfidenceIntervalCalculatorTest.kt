...
class ConfidenceIntervalCalculatorTest {
    ...
    fun testPerfectScore() {
        ...
        assertEquals(expected = 100f, actual = ci.lowerBound, delta = 0.1f)
        assertEquals(expected = 100f, actual = ci.upperBound, delta = 0.1f)
        assertEquals(expected = 0f, actual = ci.margin, delta = 0.1f)
    }
    ...
    fun testZeroScore() {
        ...
        assertEquals(expected = 0f, actual = ci.lowerBound, delta = 0.1f)
        assertEquals(expected = 0f, actual = ci.upperBound, delta = 0.1f)
        assertEquals(expected = 0f, actual = ci.margin, delta = 0.1f)
    }
    ...
    fun testSingleCorrectAnswer() {
        ...
        assertEquals(100f, ci.lowerBound, delta = 5f)
        assertEquals(100f, ci.upperBound, delta = 5f)
    }
    ...
    fun testSingleWrongAnswer() {
        ...
        assertEquals(0f, ci.lowerBound, delta = 5f)
        assertEquals(0f, ci.upperBound, delta = 5f)
    }
