...
actor DefaultLocalDataService: LocalDataService {
    ...
    nonisolated static let shared: DefaultLocalDataService = {
        do {
            return try DefaultLocalDataService()
        } catch {
    ...
    func fetchQuestions(for categoryId: String) async throws -> [Question] {
        ...
        guard let url = Bundle.main.url(forResource: "questions", withExtension: "json") else {
            throw DataServiceError.categoryNotFound(categoryId)
        }
        ...
        do {
            ...
            throw DataServiceError.invalidJSON(error.localizedDescription)
        }
    }
    ...
    func fetchCategories() async throws -> [Category] {
        ...
        guard let url = Bundle.main.url(forResource: "categories", withExtension: "json") else {
            throw DataServiceError.categoryNotFound("categories")
        }
    ...
    func saveSession(_ session: PracticeSession) async throws {
        ...
        do {
            ...
            throw DataServiceError.persistenceFailure("Fehler beim Speichern der Sitzung: \(error.localizedDescription)")
        }
    }
    ...
    func loadSession(_ id: UUID) async throws -> PracticeSession? {
        ...
        do {
            ...
            throw DataServiceError.corruptedData("Fehler beim Laden der Sitzung: \(error.localizedDescription)")
        }
    }
    ...
    func deleteSession(_ id: UUID) async throws {
        ...
        do {
            ...
            throw DataServiceError.persistenceFailure("Fehler beim Löschen: \(error.localizedDescription)")
        }
    }
}