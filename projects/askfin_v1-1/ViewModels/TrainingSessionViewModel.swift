...
final class TrainingSessionViewModel: ObservableObject {
    ...
    /// The question that was just answered — captured before index advances.
    ...
    /// Progress fraction for the progress bar (0.0–1.0).
    var progressFraction: Double { sessionProgress }
    ...
    func competence(for topic: TopicArea) -> TopicCompetence? {
        competenceService.competence(for: topic)
    }
