...
class LumaAdapter(BaseServiceAdapter):

    def __init__(self, api_key: str):
        super().__init__("luma", api_key)

    def get_capabilities(self) -> list[str]:
        return ["text_to_video", "image_to_video", "mp4_output", "max_5s"]
    ...
    async def generate(self, prompt: str, specs: dict) -> ServiceResult:
        ...
        # See docs: https://docs.lumalabs.ai/
