...
API_BASE = "https://rive.app"


class RiveAdapter(BaseServiceAdapter):

    def __init__(self, api_key: str):
        super().__init__("rive", api_key)

    def get_capabilities(self) -> list[str]:
        return ["interactive_animation", "vector_animation", "state_machine"]
