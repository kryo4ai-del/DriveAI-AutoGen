...
_FRAMEWORK_TYPES = frozenset({
    ...
    "CustomDebugStringConvertible", "IndexPath", "NSPersistentContainer", "NSManagedObject", "NSManagedObjectContext", "NavigationPath", "Transition", "Future", "PropertyListEncoder", "PropertyListDecoder", "URLRequest", "URLResponse", "HTTPURLResponse", "OperationQueue", "BreathFlow3",
    "Calendar", "Timer", "UserDefaults", "DateFormatter", "NumberFormatter",
    "URLSession", "DispatchQueue", "RunLoop", "NSCoder", "NSError", "ProcessInfo",
    "State", "AppStorage", "SceneStorage", "ContentView",
    "CaseIterable", "RawRepresentable", "Sendable",
    "Foundation", "SwiftUI", "UIKit", "BreathFlow",
    "CodingKeys", "TypeValue", "CodingKey",
    "Hashable", "Equatable", "Identifiable", "Comparable", "CustomStringConvertible", "Codable", "Encodable", "Decodable", "CaseIterable", "RawRepresentable", "Sendable", "LocalizedError", "TimeInterval", "Task", "MainActor", "Preview", "Color", "HStack", "VStack", "ZStack", "XCTest", "XCTestCase", "DriveAI", "BreathFlow", "BreathFlow3",
    "BreathFlow",
    "Observable",
    "TimelineView",
    "ToolbarItem",
