...
module.exports = {
  ...
  PATHS: {
    ...
    nameGate: path.join(FACTORY_BASE, 'factory', 'name_gate'),
    nameGateData: path.join(FACTORY_BASE, 'factory', 'name_gate', 'data'),
    productionSpecs: path.join(FACTORY_BASE, 'projects'),
    productionLogs: path.join(FACTORY_BASE, 'projects'),
    ...
    liveOpsEscalation: path.join(FACTORY_BASE, 'factory', 'live_operations', 'data', 'escalation'),
    liveOpsBriefings: path.join(FACTORY_BASE, 'factory', 'live_operations', 'data', 'briefings'),
    liveOpsSubmissions: path.join(FACTORY_BASE, 'factory', 'live_operations', 'data', 'submissions'),
    liveOpsReleases: path.join(FACTORY_BASE, 'factory', 'live_operations', 'data', 'releases'),
  },
  SCAN_INTERVAL: 15000,
